...
result1<-merge_fullname_address(first,second)
...
#Apply function:
result2 <-merge_fullname(merged,first,second,unmatched_1,unmatched_2) 
...
result3 <-merge_widow(merged,first,second,widows,unmatched_1,unmatched_2)
...
result4 <-merge_string(merged,first,second,3)
